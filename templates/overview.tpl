...
<div id="vf-sec-overview" class="vf-billing-card mb-4" data-vf-nav-label="Overview">
    <div class="vf-billing-card-title d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center" style="gap: 12px;">
            <button id="vf-vnc-button" onclick="vfOpenVnc('{$serviceid}','{$systemURL}')" type="button" class="btn btn-sm vf-btn-ghost d-flex align-items-center font-weight-bold" style="color:#475569; background:#fff; border:1px solid #e2e8f0; box-shadow:0 1px 2px rgba(0,0,0,0.05); padding: 4px 12px; border-radius: 6px;">
    ...
    <div id="vf-quick-actions" class="pt-3" style="border-top:1px solid #f1f5f9;">
        <div class="d-flex flex-wrap align-items-center" style="gap: 6px;">
            <button id="vf-power-boot" onclick="vfPowerAction('{$serviceid}','{$systemURL}','boot')" type="button" class="btn btn-sm vf-btn-power vf-btn-power-start" style="padding: 4px 10px;">
                <span class="vf-btn-spinner spinner-border spinner-border-sm" style="display:none;"></span>
                <i class="fas fa-play"></i> Start
            </button>
            <button id="vf-power-restart" onclick="vfPowerAction('{$serviceid}','{$systemURL}','restart')" type="button" class="btn btn-sm vf-btn-power vf-btn-power-restart" style="padding: 4px 10px;">
                <span class="vf-btn-spinner spinner-border spinner-border-sm" style="display:none;"></span>
                <i class="fas fa-sync-alt"></i> Restart
            </button>
            <button id="vf-power-shutdown" onclick="vfPowerAction('{$serviceid}','{$systemURL}','shutdown')" type="button" class="btn btn-sm vf-btn-power vf-btn-power-stop" style="padding: 4px 10px;">
                <span class="vf-btn-spinner spinner-border spinner-border-sm" style="display:none;"></span>
                <i class="fas fa-stop"></i> Stop
            </button>
            <button id="vf-power-poweroff" onclick="vfPowerAction('{$serviceid}','{$systemURL}','poweroff')" type="button" class="btn btn-sm vf-btn-power vf-btn-power-force" title="Force Off" style="padding: 4px 10px;">
                <span class="vf-btn-spinner spinner-border spinner-border-sm" style="display:none;"></span>
                <i class="fas fa-power-off"></i> Power Off
            </button>
            
            <div class="d-flex flex-wrap align-items-center ml-auto justify-content-end" style="gap: 6px;">
                <div class="mx-2 d-none d-md-block" style="border-left: 1px solid #e2e8f0; height: 28px;"></div>
                
                <button id="vf-reset-server-pwd" onclick="vfResetServerPassword('{$serviceid}','{$systemURL}')" type="button" class="btn btn-sm d-flex align-items-center font-weight-bold" style="background:#f5f3ff; color:#6d28d9; border:none; border-radius:8px; padding:4px 10px;">
                    <i class="fas fa-lock mr-2" style="font-size:0.8em; opacity:0.8;"></i> Reset Server Password
                </button>

                <button id="vf-reset-cp-pwd" onclick="vfUserPasswordReset('{$serviceid}','{$systemURL}')" type="button" class="btn btn-sm d-flex align-items-center font-weight-bold" style="background:#f5f3ff; color:#6d28d9; border:none; border-radius:8px; padding:4px 10px;">
                    <i class="fas fa-lock mr-2" style="font-size:0.8em; opacity:0.8;"></i> Reset Control Panel
                </button>

                <button id="vf-login-button" onclick="vfLoginAsServerOwner('{$serviceid}','{$systemURL}',true)" type="button" class="btn btn-sm btn-primary d-flex align-items-center font-weight-bold" style="border-radius:8px; padding:4px 10px;">
